...
- `main` changes only by the owner, or by the orchestrator promoting `ready-for-main` via PR after `ci` green + cross-vendor review (owner grant 2026-07-15). `ready-for-main` changes only through a pull request with `ci` green.
