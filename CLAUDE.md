...
1. **Intake:** no task starts without a one-line goal and a checkable definition of done. If either
   ...
   done-criterion via `scripts/intake` (ledger is private, untracked) BEFORE work.
...
5. **Big programs get ONE brief** (the SETUP-BRIEF shape: gates + deterministic acceptance),
